...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      ...
      className={cn(
        // min-w-0: without it this flex item's min-width floors at w-full
        // (the viewport), so sidebar + inset = viewport + 256px and EVERY
        // dashboard page scrolls sideways by the sidebar width.
