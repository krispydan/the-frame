...
export async function GET(req: NextRequest) {
  ...
  // Companies (prospects)
  const companies = safeQuery(() => sqlite
  ...
  for (const c of companies) {
    results.push({
      type: "prospect", id: c.id, title: c.name,
  ...
  // Products
  const products = safeQuery(() => sqlite
  ...
  // Orders
  const orderRows = safeQuery(() => sqlite
