...
interface DashboardStats {
  ...
  topSegments: Array<{ name: string; prospectCount: number; qualifiedCount: number; customerCount: number; campaignCount: number; activeDealCount: number; pipelineValue: number; revenue: number; orderCount: number }>;
              ...
              {stats.topSegments.map((segment) => {
                ...
                return (
                  ...
                  >
                    ...
                    >
                      <div>{segment.qualifiedCount.toLocaleString()} qualified leads</div>
                      <div>{qualificationRate.toFixed(1)}% qualified</div>
                    </Link>
                    <Link
