...
export function resetTestDb() {
  const tables = ["companies", "stores", "contacts", "deals", "deal_activities", "orders", "order_items", "settlements", "expenses", "customer_accounts", "smart_lists", "campaigns", "campaign_leads", "inventory", "inventory_factories", "inventory_movements", "inventory_purchase_orders", "inventory_po_line_items", "inventory_qc_inspections", "notifications", "catalog_products", "catalog_skus", "error_logs", "change_logs", "reporting_logs", "activity_feed", "jobs"];
  const d = getTestDb();
