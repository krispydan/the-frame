...
export const PLATFORM_CATEGORY_SUGGESTIONS: Record<string, CategorySuggestion[]> = {
  shopify_dtc: [
    ...
    { category: "adjustments",    label: "Adjustments (disputes / anomalies / reserves)", hint: "Shopify Payments balance adjustments — net of dispute wins/losses, anomaly credits/debits, reserve releases", defaultAccountCode: "5400", defaultAccountName: "Merchant Fees - Shopify Payments", side: "debit" },
  ...
  shopify_afterpay: [
    ...
    { category: "refunds",        label: "Refunds & returns",        hint: "Refunds issued to customers", defaultAccountCode: "4300", defaultAccountName: "Sales Returns & Allowances", side: "debit" },
    { category: "discounts",      label: "Discounts & promotions",   hint: "Discount totals", defaultAccountCode: "4310", defaultAccountName: "Sales Discounts & Promotions", side: "debit" },
    { category: "adjustments",    label: "Adjustments (disputes / anomalies / reserves)", hint: "BNPL balance adjustments — disputes, anomaly credits/debits, reserve releases", defaultAccountCode: "5430", defaultAccountName: "Merchant Fees - Afterpay / BNPL", side: "debit" },
  ...
  shopify_wholesale: [
    ...
    { category: "adjustments",    label: "Adjustments (disputes / anomalies / reserves)", hint: "Shopify Payments balance adjustments — disputes, anomaly credits/debits, reserve releases", defaultAccountCode: "5400", defaultAccountName: "Merchant Fees - Shopify Payments", side: "debit" },
    { category: "fees",           label: "Merchant fees",            hint: "Shopify Payments processing fee", defaultAccountCode: "5400", defaultAccountName: "Merchant Fees - Shopify Payments", side: "debit" },
  ...
  amazon: [
    ...
    { category: "fba_fulfillment",   label: "FBA fulfilment fees",      hint: "Per-unit pick/pack/ship at Amazon. Deliberately separate from 5500 3PL - Fulfillment & Pick-Pack, which is Big Sky — mixing them makes both channels' unit economics unreadable", defaultAccountCode: "5470", defaultAccountName: "Amazon Fees - FBA Fulfillment", side: "debit" },
    { category: "fba_storage",       label: "FBA storage fees",         hint: "Monthly storage at Amazon. Separate from 5510 3PL - Storage, which is Big Sky", defaultAccountCode: "5475", defaultAccountName: "Amazon Fees - FBA Storage", side: "debit" },
    { category: "subscription",      label: "Selling plan subscription", hint: "Professional selling plan, ~$39.99/mo", defaultAccountCode: "5480", defaultAccountName: "Amazon Fees - Subscription", side: "debit" },
    ...
    { category: "unclassified",      label: "Unclassified (suspense)",  hint: "Amazon fee types we have not seen before land here AND raise a Slack alert — never silently absorbed into another bucket", defaultAccountCode: "5440", defaultAccountName: "Merchant Fees - Other", side: "debit" },
